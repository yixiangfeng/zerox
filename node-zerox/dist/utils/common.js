...
var convertKeysToSnakeCase = function (obj) {
    ...
    return Object.fromEntries(Object.entries(obj).map(function (_a) {
        ...
        return [(0, exports.camelToSnakeCase)(key), value];
    }));
};
...
var runRetries = function (operation, maxRetries, pageNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var retryCount, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                console.log("Retrying page ".concat(pageNumber, "..."));
                retryCount++;
                return [3 /*break*/, 5];
            case 5: return [3 /*break*/, 1];
            case 6: throw new Error("Unexpected retry error");
        }
    });
}); };
    ...
    return {
        fullDocSchema: Object.keys(fullDocSchema).length
            ? {
                ...
                required: requiredKeys.filter(function (key) { return !extractPerPage.includes(key); }),
            }
            : null,
